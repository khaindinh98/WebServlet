...
<html lang="vi">
    ...
    <body>
        <nav class="navbar navbar-light bg-light flex-md-nowrap p-0">
            <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="<c:url value="/admin-category"/>">Categories</a>
            <%--                        <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">--%>
            <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                    <%--                                <a class="nav-link" href="#">Sign out</a>--%>
                    <a class="d-flex align-items-center text-muted" href="<c:url value="/admin-category?type=edit-view"/>" data-toggle="tooltip" title="Add Category">
