...
<html lang="vi">
    <head>
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/jquery-ui.custom.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/chosen.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/datepicker.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/bootstrap-timepicker.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/daterangepicker.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/bootstrap-datetimepicker.min.css" />" />
        <link rel="stylesheet" href="<c:url value="/templates/admin/css/colorpicker.min.css" />" />
    </head>
    <body>
        <!-- PAGE CONTENT BEGINS -->
